                      ...
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row align-items-center">
                          ...
                          <div class="col-lg-4 col-md-6">
                            <input type="text" name="tahun" value="<?php echo $jenis_bayar['tahun']; ?>" required=""/>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right text-white">NOMINAL</label>
                          <div class="col-lg-4 col-md-6">
                              <input type="text" name="nominal" value="<?php echo $jenis_bayar['nominal']; ?>" required=""/>
                          </div>  
</div>
                          <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right text-white">JENIS PEMBAYARAN</label>
                          <div class="col-lg-4 col-md-6">
                              <input type="text" name="jenis_bayar" value="<?php echo $jenis_bayar['jenis_bayar']; ?>" required=""/>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6 text-right">
                            <button type="submit" class="btn btn-icon icon-right btn-primary">UBAH SPP<i class="fas fa-arrow-right"></i></button>
                          </div>
                        </div>
                      </div>
                    </form>

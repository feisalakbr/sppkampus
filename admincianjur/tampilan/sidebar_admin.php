        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="logout_admin.php" class="dropdown-item has-icon text-danger">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="kelas.php"><i class="fas fa-database"></i> <span>DATA PRODI</span></a></li>
              <li class="dropdown">
    <a href="#" class="nav-link dropdown-toggle" id="personalDropdown">
        <span>Personal</span>
    </a>
    <ul class="dropdown-menu" id="personalMenu" style="display:none;">
        <li><a class="nav-link" href="petugas.php"><i class="fas fa-user-edit"></i> <span>PETUGAS</span></a></li>
        <li><a class="nav-link" href="user.php"><i class="fas fa-user-edit"></i> <span>USER</span></a></li>
        <li><a class="nav-link" href="siswa.php"><i class="fas fa-user-graduate"></i> <span>MAHASISWA</span></a></li>
        <li><a class="nav-link" href="siswa.php"><i class="fas fa-user-graduate"></i> <span>DOSEN</span></a></li>
    </ul>
</li>
<script>
  document.getElementById('personalDropdown').addEventListener('click', function(e) {
    e.preventDefault(); // Mencegah aksi default link
    var menu = document.getElementById('personalMenu');
...
window.addEventListener('click', function(e) {
    if (!e.target.closest('.dropdown')) {
        var menu = document.getElementById('personalMenu');
        menu.classList.remove('show'); // Hapus class "show" jika klik di luar
    }
});
</script>
              <li class="menu-header">Fitur</li>
              <li><a class="nav-link" href="transaksi.php"><i class="fas fa-money-check-alt"></i> <span>TRANSAKSI PEMBAYARAN</span></a></li>
              <li><a class="nav-link" href="bukti_bayar.php"><i class="fas fa-money-check-alt"></i> <span>BUKTI PEMBAYARAN</span></a></li>
